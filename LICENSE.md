# Orchestr Sustainable Use License
...
charge for the permitted purposes described above, and you may not remove or
obscure any licensing, copyright, or other notices.

You may not provide the software to third parties as a hosted or managed service
where the service provides users with access to any substantial set of the
features or functionality of the software, whether or not for a fee.

If these limitations do not fit your needs — for example, if you want to offer a
competing hosted service, or embed the software in a commercial product — a
commercial license is available from the licensor.
...
means ownership of substantially all the assets of an entity, or the power to
direct its management and policies by vote, contract, or otherwise. Control can be
direct or indirect.
